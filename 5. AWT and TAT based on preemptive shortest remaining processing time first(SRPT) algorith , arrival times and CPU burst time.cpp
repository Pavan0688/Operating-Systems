...
int main() {
    ...
    // Initialize the remaining burst times to the initial burst times
    ...
    while (1) {
        ...
        // Execute the process with the shortest remaining burst time for 1 millisecond
        remaining_burst_times[shortest_index]--;
        current_time++;

        // If the process has completed, record its completion time, waiting time, and turnaround time
